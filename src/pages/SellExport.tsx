    ...
    return (
      <div id="page-sell" className="page active space-y-6">
        <div className="page-header">
          <div>
            <h2>Sell Workspace</h2>
            <p>Record new sales transaction and manage export details</p>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-sm p-6 lg:p-8 space-y-8">
          <div className="flex justify-between items-center border-b border-slate-200/80 dark:border-slate-800/80 pb-4">
            <div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100">Create Sale Order</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">Fill in transaction details, select products, and process payment</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            {/* Main Form & Products Column */}
            <div className="lg:col-span-7 xl:col-span-8 space-y-6">
              {/* Order Information Section */}
              <div className="p-5 bg-slate-50/50 dark:bg-slate-950/40 rounded-xl border border-slate-200/60 dark:border-slate-800/80 space-y-4">
                <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider">Order Information</h4>
            ...
            <div className="lg:col-span-5 xl:col-span-4 space-y-6">
              <div className="retro-calc-box sticky top-6">
                ...
                <div className="pt-6 border-t border-slate-200/80 dark:border-slate-800/80 flex gap-3">
                  <button className="retro-btn-metallic-silver lg px-5" onClick={() => setShowModal(false)}>Cancel</button>
                  <button className="retro-btn-metallic-teal lg flex-1 font-bold py-3 text-base flex items-center justify-center gap-2" onClick={handleAdd}>
                    <span>Sell</span>
